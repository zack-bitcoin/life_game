...
run4(?verify_sig, D) ->
    case D#d.stack of
        [Pub|[Data|[Sig|T]]] ->
            %io:fwrite(packer:pack([Data, Sig, Pub])),
            %io:fwrite("\n"),
%[-6,"AQID","TUVVQ0lIQ1Ixc3ZwN05uTmt6Um1qTFBUZnR3OTlRZXVmSlBRamRRVXRCTlZpYWlKQWlFQWhuakh6MzFERWtTYXI0UWVRc1NrOGlJRG4rMTh4azAwYUVoTENLMWtiSmc9","BLDdkEzI6L8qmIFcSdnH5pfNAjEU11S9pHXFzY4U0JMgfvIMnwMxDOA85t6DKArhzbPJ1QaNBFHO7nRguf3El3I="]
